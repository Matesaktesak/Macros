...
toggleMercury(num){
	...
	prFocus("timeline")
	Send +!{F10} 			; Mapped to the "playback" tab in menus
	BlockInput, SendAndMouse
	BlockInput, On
	Sleep 1500				; Wait for the window to show up
	CoordMode, Mouse, client ; Set relative coordinates to that window
	MouseClick, left, 250, 240 + (num * 20)  ; move to the first box + move down the specifyed number of boxes and click
	Sleep, 10
	Send {Enter}
