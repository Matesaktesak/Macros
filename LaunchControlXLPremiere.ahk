...
MidiControlChange106: 						; Skip Backwards
	Send +{Left}
Return

MidiControlChange107: 						; Skip Forwards
	Send +{Right}
Return


MidiControlChange31: 						;Temparature
	ChangeLumetriScale(4, midi.MidiIn().Value, -100, 100, -5)
	Sleep, 10
Return
...
MidiControlChange32: 						;Tint
	ChangeLumetriScale(5, midi.MidiIn().Value, -100, 100, -3.9)
	Sleep, 10
Return
...
MidiControlChange33: 						;Exposure
	ChangeLumetriScale(6, midi.MidiIn().Value, -5, 5, -0.3)
	Sleep, 10
Return
...
MidiControlChange34: 						;Highlights
	ChangeLumetriScale(8, midi.MidiIn().Value, -100, 100, -5.5)
	Sleep, 10
Return
...
MidiControlChange61:						;Bypass
	If WinActive("ahk_exe C:\Program Files\Adobe\Adobe Premiere Pro CC 2019\Adobe Premiere Pro.exe"){
		if(bypass = 0){
			Send ^+!F9
			Send ^+!{B down}
			bypass = 1
